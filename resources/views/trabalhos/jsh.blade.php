            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="services-left mb-30">
                        <img class="img-fluid" src="assets/img/portfolio/jsh.png" alt="Service Img">
                        <h3 class="s-sub-title mt-55 mb-20">JSI Research & Training Institute, Inc. (JSI)</h3>
                        <p class="mb-30">Provisão de serviços de Migração de Ambientes da Ferramenta Central.</p>
                        {{-- <ul>
