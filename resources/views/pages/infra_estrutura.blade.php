                ...
                <div class="col-lg-8">
                    <div class="services-left mb-30">
                        ...
                        <p class="mb-30">Na Escopil, uma das nossas áreas de actuação consiste na montagem de redes e infra-estruturas de Tecnologias de Informação para vários cenários de ligação de redes.
                            Oferecemos:</p>
                        <ul>
                            <li>Colocação em funcionamento e manutenção de infra-estruturas de hardware</li>
                            <li>Colocação em funcionamento e manutenção de infra-estruturas de redes</li>
                            <li>Virtualização de plataformas</li>
                            <li>Apoio permanente 24/7</li>
                        </ul>
