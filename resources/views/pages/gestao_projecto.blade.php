            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="services-left mb-30">
                        <img class="img-fluid" src="assets/img/services/serv10.jpg" alt="Service Img">
                        <h3 class="s-sub-title mt-55 mb-20"> Gestão de Projectos</h3>
                        <p class="mb-30">Na Escopil, uma das nossas áreas de actuação consiste na montagem de redes e infra-estruturas de Tecnologias de Informação.

                            Algumas das ferramentas de gestão:</p>
                        <ul>
                            <li>Risk assessment</li>
                            <li>Sistemas ISO</li>
                            <li>Prince 2</li>
                            <li>Engineering Procurement and Contract Management (EPCM)</li>
