            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="services-left mb-30">
                        ...
                        <h3 class="s-sub-title mt-55 mb-20">Future is brighter when you’re more prepared</h3>
                        <p class="mb-30">A recognizable and loved brand is one of the most valuable assets a company
                            owns. In
                            fact, 59% of customers
                            prefer to buy products from brands they know. How do you become a sought-after brand
                            with endless sales and raving fans? By identifying your promise to a customer or client.
                            The challenge is communicating a clear and cohesive message.</p>
                        <p><a href="contact.html">Finanix</a> team is a diverse network of consultants
                            and industry
                            professionals with a global mindset and a collaborative culture. We work to understand
                            your issues and are driven to ask better questions in the pursuit.</p>
                        <div class="row px-0 mt-55 mb-20">
                            <div class="col-lg-4 col-md-4">
                                <div class="details-box text-center mb-30">
                                    ...
                                    <h5 class="mb-10">Discuss Project</h5>
                                    <p>We work to understand your
                            ...
                            <div class="col-lg-4 col-md-4">
                                <div class="details-box text-center mb-30">
                                    ...
                                    <h5 class="mb-10">Filter Every Issues</h5>
                                    <p>We work to understand your
                                        issues and are driven</p>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4">
                                <div class="details-box text-center mb-30">
                                    ...
                                    <h5 class="mb-10">Give Good Solution</h5>
                                    <p>We work to understand your
                                        issues and are driven</p>
                                </div>
                            </div>
                    ...
                    <div class="services-right-widget">
                        <div class="widget widget-categories mb-40">
                            <div class="widget-title-box pb-25 mb-30">
                                ...
                                <h4 class="widget-sub-title2">Type Of Services</h4>
                            </div>
                            <ul class="list-none">
                                <li><a href="#">Software services <span class="f-right"><i
                                                class="fal fa-long-arrow-right"></i></span></a></li>
                                <li><a href="#">Training services <span class="f-right"><i
                                                class="fal fa-long-arrow-right"></i></span></a></li>
                                <li><a href="#">Event planning services <span class="f-right"><i
                                                class="fal fa-long-arrow-right"></i></span></a></li>
                                <li><a href="#">Consulting services <span class="f-right"><i
                                                class="fal fa-long-arrow-right"></i></span></a></li>
                                <li><a href="#">Marketing services <span class="f-right"><i
                                                class="fal fa-long-arrow-right"></i></span></a></li>
                                <li><a href="#">Construction services <span class="f-right"><i
                                                class="fal fa-long-arrow-right"></i></span></a></li>
                            </ul>
                        </div>
                        <div class="widget widget-subscribe mb-40">
                            <div class="widget-title-box pb-25 mb-30">
                                ...
                                <h4 class="widget-sub-title2">Get In Touch</h4>
                            </div>
